var app = new Vue({
    ...
    data: {
        ...
        nome: "",
        tuturial: 0,
        querFazerTuturial: false,
        decisaoTuturial: false,
        cadastrare: false,
        login: false
    },
    methods: {
        ...
        descisaoTuto(decisao){
            if(decisao == 'sim'){
                this.querFazerTuturial = true
            } else{
                this.querFazerTuturial = false
                this.decisaoTuturial = true
            }
        },
        buttonHome(){
            this.login = false;
            this.cadastrare = true;
        },
        backHome(){
            this.login = false;
